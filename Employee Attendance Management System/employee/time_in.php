...
if(isset($firstname) && isset($surname) && isset($lastname) && isset($staffid) && isset($idno) 
	&& isset($department) && isset($supervisor) && isset($time_in) && isset($date)){

if(!empty($firstname)&& !empty($surname) && !empty($lastname) && !empty($staffid) && !empty($idno) 
	&& !empty($department)&& !empty($supervisor) && !empty($time_in) && !empty($date)){

	$insertsql=mysql_query("INSERT INTO time_in (firstname, surname, lastname, staffid, idno, department, supervisor, time_in, date) 
		VALUES('".$firstname."','".$surname."','".$lastname."','".$staffid."','".$idno."','".$department."','".$supervisor."','".$time_in."','".$date."')"); 
